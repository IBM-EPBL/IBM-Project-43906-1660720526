...
client = MongoClient(
    'mongodb+srv://keerthanaanandh4:<password>@cluster0.fnsakkg.mongodb.net/?retryWrites=true&w=majority')
db = client['medicine_schedule']
scheduledb = db['schedule']
users = db['users']

twilio_client = Client('AC2e0d514d25639980c5e57208fb4714ed', '972249cde741ec0dd087dffb0a8c757f')
